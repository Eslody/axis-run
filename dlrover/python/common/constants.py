...
class NodeEnv(object):
    ...
    # 外部 Diagnostician 扩展点。格式为逗号分隔的 "module_path::ClassName" 列表，
    # 例如 "axis_run.diagnosis.fault_config::FaultConfigDiagnostician"。
    # 每个类必须继承自 dlrover.python.diagnosis.common.diagnostician.Diagnostician，
    # 且构造函数支持无参调用（可从环境变量读取配置）。
    DLROVER_EXTENSION_DIAGNOSTICIAN = "DLROVER_EXTENSION_DIAGNOSTICIAN"
